...
class TablaPeligro extends StatelessWidget {
  static controllerTabla C = Get.find<controllerTabla>();
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      rows: <DataRow>[
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('MECANICOS: Mecanismos en movimientos, Ele. cortanas, Proy. de particulas')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[5].value,
                        onChanged: (bool? val) {
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('Sistema de monitoreo - Acompañamiento policiaco.')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[30].value,
                        onChanged: (bool? val) {
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('Señalización con vallas, conos, tubulares, cinta, etc.')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[33].value,
                        onChanged: (bool? val) {
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('BIOLOGICO: Virus, hongos, bacterias, animales, COVID-19')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[35].value,
                        onChanged: (bool? val) {
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('FISICO: Temperaturas extremas, ilumionación, ruido, radiaciones.')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[41].value,
                        onChanged: (bool? val) {
        ...
        DataRow(
          cells: <DataCell>[
            DataCell(Text('LOCATIVOS: Defectos del piso (lisos, irregulares, humedos o fangosos).')),
            DataCell(Obx (() => Checkbox(
                        value: C.si[49].value,
                        onChanged: (bool? val) {
